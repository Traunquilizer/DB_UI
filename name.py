...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lab_stuff.setGeometry(QtCore.QRect(250, 50, 131, 21))
        ...
        self.cBox_receiver.setGeometry(QtCore.QRect(250, 220, 121, 21))
        ...
        self.line_product_name.setGeometry(QtCore.QRect(20, 70, 211, 21))
        self.line_product_name.setObjectName("line_product_name")
        self.line_name = QtWidgets.QLineEdit(self.centralWidget)
        self.line_name.setGeometry(QtCore.QRect(20, 120, 211, 21))
        self.line_name.setObjectName("line_name")
        self.line_phone = QtWidgets.QLineEdit(self.centralWidget)
        self.line_phone.setGeometry(QtCore.QRect(40, 170, 191, 21))
        self.line_phone.setObjectName("line_phone")
        MainWindow.setCentralWidget(self.centralWidget)

        self.retranslateUi(MainWindow)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)
        MainWindow.setTabOrder(self.line_product_name, self.line_name)
        MainWindow.setTabOrder(self.line_name, self.line_phone)
        MainWindow.setTabOrder(self.line_phone, self.dateEdit)
        MainWindow.setTabOrder(self.dateEdit, self.textf_stuff)
        MainWindow.setTabOrder(self.textf_stuff, self.cBox_receiver)
